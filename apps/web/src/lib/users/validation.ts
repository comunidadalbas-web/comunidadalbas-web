...
export const USER_ROLES = ['admin', 'director', 'tesorero', 'secretario', 'vocal', 'resident'] as const;
...
export const updateUserSchema = z
  .object({
    ...
    password: z.string().min(12, 'La contraseña debe tener al menos 12 caracteres').max(200).optional(),
  })
